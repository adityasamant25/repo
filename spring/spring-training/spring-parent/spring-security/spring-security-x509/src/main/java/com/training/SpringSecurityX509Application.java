...
public class SpringSecurityX509Application extends WebSecurityConfigurerAdapter {

	public static void main(String[] args) {
		SpringApplication.run(SpringSecurityX509Application.class, args);
	}

	private final AccountUserDetailsService accountUserDetailsService;

	@Autowired
	public SpringSecurityX509Application(AccountUserDetailsService accountUserDetailsService) {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().anyRequest().authenticated().and().x509().and().sessionManagement()
