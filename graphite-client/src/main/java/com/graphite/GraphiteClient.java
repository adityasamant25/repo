...
public class GraphiteClient {
	 ...
	 * @throws Exception 
	 */
	public void sendMetrics(Map<String, Number> metrics) throws Exception {
	 ...
	 * @throws Exception 
	 */
	public void sendMetrics(Map<String, Number> metrics, long timeStamp) throws Exception {
		try {
			...
			throw new Exception("Unknown host: " + graphiteHost);
		} catch (IOException e) {
			throw new Exception("Error while writing data to graphite: " + e.getMessage(), e);
		}
	}
	 ...
	 */
	public void sendMetric(String key, Number value) throws Exception {
	...
	public void sendMetric(final String key, final Number value, long timeStamp) throws Exception {
